# -*- coding: utf-8 -*-
#
# JSON Document documentation build configuration file, created by
...
htmlhelp_basename = 'JSONDocumentdoc'
...
latex_documents = [
  ('index', 'JSONDocument.tex', u'JSON Document Documentation',
...
man_pages = [
    ('index', 'jsondocument', u'JSON Document Documentation',
...
texinfo_documents = [
  ('index', 'JSONDocument', u'JSON Document Documentation',
   u'Zygmunt Krynicki', 'JSONDocument', 'One line description of project.',
   'Miscellaneous'),
]
